"""
ETL Pipeline: BA Economic Sector Employment & Wages
Source: Federal Employment Agency (BA) - Sheet 8.3
Period: 2020-2024
Indicators: 92-94
"""
...
from src.extractors.ba.economic_sector_extractor import EconomicSectorExtractor
...
def main():
    """Run complete ETL pipeline for BA economic sector data."""
    print("=" * 80)
    print("ETL PIPELINE: BA ECONOMIC SECTOR DATA")
    print("Source: Federal Employment Agency (BA) - Sheet 8.3")
    print("Period: 2020-2024 | Indicators: 92-94")
    print("=" * 80)
    print()
    ...
    print(f"  Sectors: {df_raw['sector_name'].nunique()}")
    print()
    ...
    df_transformed = transformer.transform_sectors(df_raw)
    ...
    for ind_id in sorted(df_transformed['indicator_id'].unique()):
        ...
        ind_name = {92: "Employment by Sector", 93: "Median Wage by Sector", 94: "Wage Distribution by Sector"}
    ...
    print("Indicators 92-94 now available for sectoral analysis")
    print()
