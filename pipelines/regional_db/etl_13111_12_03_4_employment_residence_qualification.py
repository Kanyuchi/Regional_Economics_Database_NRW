"""
ETL Pipeline: Table 13111-12-03-4
=================================
Employees at place of RESIDENCE by gender, nationality, and vocational education qualification
Reference date: June 30

Source: Regional Database Germany (Regionalstatistik)
Table ID: 13111-12-03-4
...
Usage:
    python pipelines/regional_db/etl_13111_12_03_4_employment_residence_qualification.py
...
# Pipeline metadata
PIPELINE_INFO = {
    "table_id": "13111-12-03-4",
    "table_name": "Employees at residence by vocational education qualification",
    "source": "regional_db",
    "category": "labor_market",
    "available_period": "2008-2024",
    "reference_date": "June 30",
    "geographic_level": "districts",
    "indicator_id": 16,  # emp_qualification_residence (Employment by qualification at residence)
}
...
def run_pipeline(years: list = None) -> bool:
    """
    Run the complete ETL pipeline for table 13111-12-03-4.
    ...
    try:
        ...
        raw_data = extractor.extract_employees_residence_qualification(years=years)
        ...
        transformed_data = transformer.transform_residence_qualification_employment(
            raw_data,
