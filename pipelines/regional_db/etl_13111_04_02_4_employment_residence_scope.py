"""
ETL Pipeline: Table 13111-04-02-4
=================================
Employees at place of RESIDENCE by gender, nationality, and employment scope (full-time/part-time)
Reference date: June 30

Source: Regional Database Germany (Regionalstatistik)
Table ID: 13111-04-02-4
Category: Labor Market
Available Period: 2008-2024

Description:
    Extracts employment data at residence (not workplace) broken down by:
    - Gender (male/female/total)
    - Nationality (German/foreign/total)
    - Employment scope (full-time/part-time/total)
    - Geographic level: Districts and independent cities
    - Reference date: June 30 each year

Usage:
    python pipelines/regional_db/etl_13111_04_02_4_employment_residence_scope.py
...
# Pipeline metadata
PIPELINE_INFO = {
    "table_id": "13111-04-02-4",
    "table_name": "Employees at residence by employment scope (full-time/part-time)",
    "source": "regional_db",
    "category": "labor_market",
    "available_period": "2008-2024",
    "reference_date": "June 30",
    "geographic_level": "districts",
    "indicator_id": 15,  # emp_scope_residence (Employment by scope at residence)
}
...
def run_pipeline(years: list = None) -> bool:
    """
    Run the complete ETL pipeline for table 13111-04-02-4.
    ...
    try:
        ...
        raw_data = extractor.extract_employees_residence_scope(years=years)
        ...
        transformed_data = transformer.transform_residence_scope_employment(
            raw_data,
