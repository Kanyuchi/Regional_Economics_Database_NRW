"""
ETL Pipeline: Table 13111-01-03-4
=================================
Employees subject to social insurance at workplace by gender and nationality
...
Usage:
    python pipelines/regional_db/etl_13111_01_03_4_employment.py
...
# Pipeline metadata
PIPELINE_INFO = {
    "table_id": "13111-01-03-4",
    "table_name": "Employees at workplace by gender and nationality",
    "source": "regional_db",
    "category": "labor_market",
    "available_period": "2008-2024",
    "reference_date": "June 30",
    "geographic_level": "districts",
    "indicator_id": 9,  # Employment total from dim_indicator
}
...
def run_pipeline(years: list = None) -> bool:
    """
    Run the complete ETL pipeline for table 13111-01-03-4.
    ...
    try:
        ...
        raw_data = extractor.extract_employees_workplace(years=years)
        ...
        transformed_data = transformer.transform_workplace_employment(
            raw_data,
