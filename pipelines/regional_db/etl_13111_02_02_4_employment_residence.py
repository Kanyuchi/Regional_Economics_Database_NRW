"""
ETL Pipeline: Table 13111-02-02-4
=================================
Employees subject to social insurance at place of RESIDENCE by gender and nationality
Reference date: June 30

Source: Regional Database Germany (Regionalstatistik)
Table ID: 13111-02-02-4
Category: Labor Market
Available Period: 2008-2024

Description:
    Extracts employment data at place of residence (vs workplace) broken down by:
...
Usage:
    python pipelines/regional_db/etl_13111_02_02_4_employment_residence.py
...
# Pipeline metadata
PIPELINE_INFO = {
    "table_id": "13111-02-02-4",
    "table_name": "Employees at place of residence by gender and nationality",
    "source": "regional_db",
    "category": "labor_market",
    "available_period": "2008-2024",
    "reference_date": "June 30",
    "geographic_level": "districts",
    "indicator_id": 14,  # emp_residence (Employment at place of residence)
}
...
def run_pipeline(years: list = None) -> bool:
    """
    Run the complete ETL pipeline for table 13111-02-02-4.
    ...
    try:
        ...
        raw_data = extractor.extract_employees_residence(years=years)
        ...
        transformed_data = transformer.transform_residence_employment(
            raw_data,
