"""
ETL Pipeline: Table 44231-01-02-4
=================================
Businesses, employed persons, total turnover - Reference date 30.06

Source: Regional Database Germany (Regionalstatistik)
Table ID: 44231-01-02-4
Category: Business Economy / Total Turnover
Available Period: 1995-2024 (30 years)

Description:
    Extracts total turnover statistics for ALL businesses including:
    - Number of businesses
    - Number of employees
    - Total turnover (previous year) - often not available
...
Usage:
    ...
    python pipelines/regional_db/etl_44231_01_02_4_total_turnover.py --years 2020 2021 2022 2023 2024
...
# Pipeline metadata
PIPELINE_INFO = {
    "table_id": "44231-01-02-4",
    "table_name": "Businesses, employed persons, total turnover",
    "source": "regional_db",
    ...
    "indicator_id": 21,  # total_turnover
}
...
def run_pipeline(years: list = None) -> bool:
    """
    Run the complete ETL pipeline for table 44231-01-02-4.
    ...
    try:
        ...
        raw_data = extractor.extract_total_turnover(years=years)
        ...
        transformed_data = transformer.transform_total_turnover(
            raw_data,
