"""
ETL Pipeline: Table 13111-07-05-4
=================================
Employees subject to social insurance at workplace by gender, nationality, and economic sectors
...
Description:
    ...
    - Economic sectors (WZ 2008 classification)
    - Geographic level: Districts and independent cities
    - Reference date: June 30 each year

Usage:
    python pipelines/regional_db/etl_13111_07_05_4_employment_sector.py
...
# Pipeline metadata
PIPELINE_INFO = {
    "table_id": "13111-07-05-4",
    "table_name": "Employees at workplace by gender, nationality, and economic sectors",
    "source": "regional_db",
    "category": "labor_market",
    "available_period": "2008-2024",
    "reference_date": "June 30",
    "geographic_level": "districts",
    "indicator_id": 17,  # emp_sector_workplace (Employment by economic sector at workplace)
}
...
def run_pipeline(years: list = None) -> bool:
    """
    Run the complete ETL pipeline for table 13111-07-05-4.
    ...
    try:
        ...
        raw_data = extractor.extract_employees_by_sector(years=years)
        ...
        transformed_data = transformer.transform_sector_employment(
            raw_data,
        ...
        # Use the employment loader (same structure as demographics)
