"""
ETL Pipeline for Migration Background and Employment Status Data
Table: 12211-9134i
Indicator: 86
Period: 2016-2019
"""
...
from src.extractors.state_db.migration_background_extractor import MigrationBackgroundExtractor
from src.transformers.migration_background_transformer import MigrationBackgroundTransformer
...
def main():
    """Run complete ETL pipeline for migration background data."""
    print("=" * 80)
    print("ETL PIPELINE: MIGRATION BACKGROUND AND EMPLOYMENT STATUS")
    print("Table: 12211-9134i | Indicator: 86 | Period: 2016-2019")
    print("=" * 80)
    print()
    ...
    try:
        ...
        print(f"    Migration backgrounds: {df_transformed['notes'].str.extract(r'migration_background:([^|]+)')[0].nunique()}")
